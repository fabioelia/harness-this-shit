    ...
    >
      ...
      <div className="min-w-0 pr-3.5">
        <div className="flex items-center gap-2">
          ...
          {r.snoozedUntil > 0 && <span title={`snoozed until ${new Date(r.snoozedUntil).toLocaleString()}${r.snoozeReason ? ` — ${r.snoozeReason}` : ''}`} className="shrink-0 rounded-full border border-lease/40 bg-lease/10 px-1.5 py-px font-mono text-[10px] font-semibold text-lease">💤</span>}
