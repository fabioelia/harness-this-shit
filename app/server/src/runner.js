...
export function runClaude(prompt, { timeoutMs = 240_000, tools = [], onEvent, onChild, model, effort, memoryDir, mcpConfig, runId, coalesce } = {}) {
...
export function buildPrompt(routine, event, constraints = [], { memoryDir, coalesce = false, seedTasks = [] } = {}) {
